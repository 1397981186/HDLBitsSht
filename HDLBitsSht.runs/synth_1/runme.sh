...
HD_PWD='E:/FPGACode/HDLBitsSht/HDLBitsSht.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log led_water.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source led_water.tcl
